...
public class RockControllerTest {
    ...
    public void testGetRock() throws IOException {  // getRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Galactic Agent", "igneous", 10, 25, "spherical", "A rock", "rock.png", 3, "", "tunic");
    ...
    public void testCreateRock() throws IOException {  // createRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Wi-Fire", "igneous", 10, 25, "spherical", "A rock", "rock.png", 3, "", "");
    ...
    public void testCreateRockFailed() throws IOException {  // createRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Bolt", "igneous", 10, 25, "spherical", "A rock", "rock.png", 3, "", "");
    ...
    public void testCreateRockHandleException() throws IOException {  // createRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Ice Gladiator", "igneous", 10, 25, "spherical", "A rock", "rock.png", 4, "cap", "");
    ...
    public void testUpdateRock() throws IOException { // updateRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Wi-Fire", "igneous", 10, 25, "spherical", "A rock", "rock.png", 5, "", "blazer");
    ...
    public void testUpdateRockFailed() throws IOException { // updateRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Galactic Agent", "igneous", 10, 25, "spherical", "A rock", "rock.png", 5, "pith helmet", "tunic");
        // when updateRock is called, return true simulating successful
        // update and save
    ...
    public void testUpdateRockHandleException() throws IOException { // updateRock may throw IOException
        // Setup
        Rock rock = new Rock(99,"Galactic Agent", "igneous", 10, 25, "spherical", "A rock", "rock.png", 7, "", "");
    ...
    public void testGetRocks() throws IOException { // getRocks may throw IOException
        ...
        rocks[0] = new Rock(99,"Bolt", "igneous", 10, 25, "spherical", "A rock", "rock.png", 1, "hat", "");
        rocks[1] = new Rock(100,"The Great Iguana", "igneous", 10, 25, "spherical", "A rock", "rock.png", 5, "", "");
    ...
    public void testSearchRocks() throws IOException { // findRocks may throw IOException
        ...
        Rock[] rocks = new Rock[2];
        rocks[0] = new Rock(99,"Galactic Agent", "igneous", 10, 25, "spherical", "A rock", "rock.png", 1, "", "tunic");
        rocks[1] = new Rock(100,"Ice Gladiator", "igneous", 10, 25, "spherical", "A rock", "rock.png", 2, "cap", "shirt");
