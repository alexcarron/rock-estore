...
Our code coverage dropped from 92% in Sprint 2 to 80% in Sprint 3. This is mostly due to a refactoring of how carts store rocks. The refactoring began just before Sprint 3 was due, so we prioritized having a functional MVP over hitting 90% code coverage. 
...
We used SonarQube and SonarScanner to perform a static code analysis on our codebase and recieved the following results.
